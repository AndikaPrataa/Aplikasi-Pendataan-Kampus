    ...
    <div class="row no-gutters">
      <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link text-white" href="<?php echo base_url('admin/pengumuman') ?>"><i class="fa-solid fa-paper-plane mr-2"></i>Pengumuman</a> <hr class="bg-secondary">
            </li>
            <li class="nav-item">
      ...
      <div class="col-md-10 p-5 pt-2">
        ...
        <?php foreach($jadwal_kuliah as $jad) : ?>
        <form method="post" action="<?php echo base_url('admin/jadwal_kuliah/edit_dataAksi') ?>">
          <div>
            <label>Mata Kuliah</label>
            <input type="hidden" name="id_kuliah" class="form-control" value="<?php echo $jad->id_kuliah ?>">
            <input type="text" name="mata_kuliah" class="form-control" value="<?php echo $jad->mata_kuliah ?>">
          </div>
          <div>
            <label>Dosen Pengampu</label>
            <input type="text" name="dosen_pengampu" class="form-control" value="<?php echo $jad->dosen_pengampu ?>">
          </div>
          <div>
            <label>Hari</label>
            <input type="text" name="hari" class="form-control" value="<?php echo $jad->hari ?>">
          </div>
          <div>
            <label>Jam</label>
            <input type="time" name="jam" class="form-control" value="<?php echo $jad->jam ?>">
          </div>
          <div>
            <button type="submit" class="btn btn-success mt-3 btn-sm" ><i class="fa fa-save mr-1"></i>Simpan data</button>
            <a href="<?php echo base_url('admin/jadwal_kuliah') ?>" class="btn btn-warning btn-sm mt-3" >Kembali</a>
          </div>
        </form>
      <?php endforeach; ?>
      </div>
