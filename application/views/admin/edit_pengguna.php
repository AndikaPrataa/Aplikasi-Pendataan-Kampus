  ...
  <body>
    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-10 p-5 pt-2">
        ...
        <form method="post" action="<?php echo base_url('admin/data_pengguna/edit_dataAksi') ?>">
          <div>
            <label>Nama</label>
            <input type="hidden" name="id_pengguna" class="form-control" value="<?php echo $peg->id_pengguna ?>">
            <input type="text" name="nama" class="form-control" value="<?php echo $peg->nama ?>">
          </div>
          <div>
            <label>Username</label>
            <input type="text" name="username" class="form-control" value="<?php echo $peg->username ?>">
          </div>
            <button type="submit" class="btn btn-success mt-3 btn-sm" ><i class="fa fa-save mr-1"></i>Simpan data</button>
            <a href="<?php echo base_url('admin/data_pengguna') ?>" class="btn btn-warning btn-sm mt-3" >Kembali</a>
          </div>
        </form>
      <?php endforeach; ?>
      </div>
