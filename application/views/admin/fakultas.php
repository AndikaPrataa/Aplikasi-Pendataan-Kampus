  ...
  <body>
    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-10 p-5 pt-2">
        <h3><i class="fa-solid fa-paper-plane mr-2"></i>FAKULTAS</h3><hr>
        <a href="<?php echo base_url('admin/fakultas/tambah_data') ?>" class="btn btn-success btn-sm">Tambah Data</a><br><br>
            ...
            <tr>
              ...
              <tbody>
                <?php $no=1; foreach($fakultas as $fk) : ?>
                  <tr>
                    <td><?php echo $no++ ?></td>
                    <td><?php echo $fk->kode ?></td>
                    <td><?php echo $fk->nama_fakultas ?></td>
                    <td>
                      <a href="<?php echo base_url('admin/fakultas/updateData/'.$fk->id_fakultas) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> Edit Data</a>
                      <a onclick="return confirm('Yakin apakah data akan dihapus?')" href="<?php echo base_url('admin/fakultas/hapus/'.$fk->id_fakultas) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash" ></i> Hapus</a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
