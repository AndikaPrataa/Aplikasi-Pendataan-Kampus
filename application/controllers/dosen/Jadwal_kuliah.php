...
class Jadwal_kuliah extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('dosen/halaman_jadwal_kuliah', $data);
	}

	public function tambah_data()
	{
		$this->load->view('dosen/form_tambahdata_jadwal');
	}
	...
	public function updateData($id)
	{
		...
		$this->load->view('dosen/edit_jadwal', $data);
	}
	...
	public function detail($id)
	{
		...
		$data['detail']=$detail;
		$this->load->view('dosen/detail_jadwal_kuliah', $data);
	}
