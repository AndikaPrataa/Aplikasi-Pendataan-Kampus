  ...
  <body>
    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-10 p-5 pt-2">
        ...
        <a href="<?php echo base_url('admin/data_dosen/tambah_data') ?>" class="btn btn-success btn-sm">Tambah Data</a><br><br>
            ...
            <tr>
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo base_url('admin/data_dosen/updateData/'.$dsn->id_dosen) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> Edit Data</a>
                      <a href="<?php echo base_url('admin/data_dosen/detail/' .$dsn->id_dosen)?>" class="btn btn-primary btn-sm"><i class="fa fa-search"></i> Detail</a>
                      <a onclick="return confirm('Yakin apakah data akan dihapus?')" href="<?php echo base_url('admin/data_dosen/hapus/'.$dsn->id_dosen) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash" ></i> Hapus</a>
                    </td>
                  </tr>
                  <?php endforeach; ?>
              </tbody>
