  ...
  <body>
    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-10 p-5 pt-2">
        ...
        <form method="post" action="<?php echo base_url('dosen/jadwal_kuliah/edit_dataAksi') ?>">
          <div>
          ...
          <div>
            ...
            <a href="<?php echo base_url('dosen/jadwal_kuliah') ?>" class="btn btn-warning btn-sm mt-3" >Kembali</a>
          </div>
        </form>
      <?php endforeach; ?>
      </div>
