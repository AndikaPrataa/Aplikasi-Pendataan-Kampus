  ...
  <body>
    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-10 p-5 pt-2">
        ...
        <a href="<?php echo base_url('dosen/mahasiswa/tambah_data') ?>" class="btn btn-success btn-sm">Tambah Data</a><br><br>
            ...
            <tr>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?php echo base_url('dosen/mahasiswa/updateData/'.$mhs->id_mahasiswa) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> Edit Data</a>
                    <a href="<?php echo base_url('dosen/mahasiswa/detail/' .$mhs->id_mahasiswa)?>" class="btn btn-primary btn-sm"><i class="fa fa-search"></i> Detail</a>
                    <a onclick="return confirm('Yakin apakah data akan dihapus?')" href="<?php echo base_url('dosen/mahasiswa/hapus/'.$mhs->id_mahasiswa) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash" ></i> Hapus</a>
                  </td>
                </tr>
                <?php endforeach; ?>
              </tbody>
