  ...
  <body>
    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-10 p-5 pt-2">
        <h3><i class="fa-solid fa-graduation-cap mr-2"></i>Detail Data Mahasiswa</h3><hr>
        ...
        <br>
        <a href="<?php echo base_url('dosen/Jadwal_kuliah') ?>" class="btn btn-danger btn-sm">Kembali</a>
      </div>
