  ...
  <body>
    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-10 p-5 pt-2">
        ...
        <form method="post" action="<?php echo base_url('admin/data_dosen/edit_dataAksi') ?>">
          <div>
            <label>Nama</label>
          ...
          <div>
            ...
            <select name="fakultas" class="form-control"  value="<?php echo $dsn->fakultas ?>">
          ...
          <div>
            ...
            <input type="text" name="mata_kuliah" class="form-control" value="<?php echo $dsn->mata_kuliah ?>">
          </div>
          <div>
            <button type="submit" class="btn btn-success mt-3 btn-sm" ><i class="fa fa-save mr-1"></i>Simpan data</button>
            <a href="<?php echo base_url('admin/data_dosen') ?>" class="btn btn-warning btn-sm mt-3" >Kembali</a>
          </div>
        </form>
      <?php endforeach; ?>
      </div>
