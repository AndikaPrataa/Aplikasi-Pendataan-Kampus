  ...
  <body>
    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-10 p-5 pt-2">
        <h3><i class="fa-solid fa-paper-plane mr-2"></i>Data Pengguna</h3><hr>
        <a href="<?php echo base_url('admin/data_pengguna/tambah_data') ?>" class="btn btn-success btn-sm">Tambah Data</a><br><br>
        ...
        <table class="table table-striped table-hover table-bordered">
          <head>
            <tr>
              ...
              <th>Aksi</th>
              <tbody>
                <?php $no=1; foreach($pengguna as $peg) : ?>
                  <tr>
                    <td><?php echo $no++ ?></td>
                    <td><?php echo $peg->nama ?></td>
                    <td><?php echo $peg->username ?></td>
                    <td>
                      <a href="<?php echo base_url('admin/data_pengguna/updateData/'.$peg->id_pengguna) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> Edit Data</a>
                      <a onclick="return confirm('Yakin apakah data akan dihapus?')" href="<?php echo base_url('admin/data_pengguna/hapus/'.$peg->id_pengguna) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash" ></i> Hapus</a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
