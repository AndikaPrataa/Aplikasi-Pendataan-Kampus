  ...
  <body>
    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-10 p-5 pt-2">
        <h3><i class="fa-solid fa-graduation-cap mr-2"></i>Detail Data Pegawai</h3><hr>
              ...
              <div class="card-body">
                <table border="0" class="table table-striped table-hover table-bordered">
                    ...
                    <tr>
                        <td>Bagian Kerja</td>
                        <td>:</td>
                        <td><?php echo $detail->bagian_kerja ?></td>
                    </tr>
                </table>   
              </div>
            </div>
        ...
        <br>
        <a href="<?php echo base_url('admin/data_pegawai') ?>" class="btn btn-danger btn-sm">Kembali</a>
      </div>
