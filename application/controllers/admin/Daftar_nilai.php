...
class Daftar_nilai extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('admin/halaman_daftar_nilai', $data);
	}

		public function tambah_data()
	{
		$this->load->view('admin/form_tambahdata_nilai');
	}
	...
	public function detail($id)
	{
		...
		$data['detail']=$detail;
		$this->load->view('admin/detail_daftar_nilai', $data);
	}
}
 ?>