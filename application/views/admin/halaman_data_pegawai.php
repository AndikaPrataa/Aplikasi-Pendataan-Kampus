  ...
  <body>
    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-10 p-5 pt-2">
        <h3><i class="fa-solid fa-user-gear mr-2"></i>DATA PEGAWAI</h3><hr>
        <a href="<?php echo base_url('admin/data_pegawai/tambah_data') ?>" class="btn btn-success btn-sm">Tambah Data</a><br><br>
            ...
            <tr>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $peg->bagian_kerja ?></td>
                  <td>
                    <a href="<?php echo base_url('admin/data_pegawai/updateData/'.$peg->id_pegawai) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> Edit Data</a>
                    <a href="<?php echo base_url('admin/data_pegawai/detail/' .$peg->id_pegawai)?>" class="btn btn-primary btn-sm"><i class="fa fa-search"></i> Detail</a>
                    <a onclick="return confirm('Yakin apakah data akan dihapus?')" href="<?php echo base_url('admin/data_pegawai/hapus/'.$peg->id_pegawai) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash" ></i> Hapus</a>
                  </td>
                </tr>
                <?php endforeach; ?>
              </tbody>
      ...
      <div class="modal-body">
        <form>
          ...
          <div>
            ...
            <input type="text" name="bagian_kerja" class="form-control">
          </div>
          <div>
