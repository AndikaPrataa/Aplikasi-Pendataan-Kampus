  ...
  <body>
    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-10 p-5 pt-2">
        ...
        <form method="post" action="<?php echo base_url('admin/mahasiswa/edit_dataAksi') ?>">
          <div>
          ...
          <div>
            <label>No. Telp</label>
            <input type="number" name="no_telp" class="form-control" value="<?php echo $mhs->no_telp ?>">
          </div>
          <div>
            <label>Fakultas</label>
            <select name="fakultas" class="form-control">
              <option value="<?php echo $mhs->fakultas ?>"><?php echo $mhs->fakultas ?></option>
              <?php foreach ($fakultas as $fak):?>
              <option value="<?php echo $fak->nama_fakultas ?>"><?php echo $fak->nama_fakultas ?></option>
              <?php endforeach; ?> 
            </select>
          </div>
          <div>
            ...
            <select name="status" class="form-control">
              <option value="<?php echo $mhs->status ?>"><?php echo $mhs->status ?></option>
