  ...
  <body>
    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-10 p-5 pt-2">
        ...
        <form method="post" action="<?php echo base_url('admin/fakultas/edit_dataAksi') ?>">
          <div>
            <label>Kode Fakultas</label>
            <input type="hidden" name="id_fakultas" class="form-control" value="<?php echo $fak->id_fakultas ?>">
            <input type="text" name="kode" class="form-control" value="<?php echo $fak->kode ?>">
          </div>
          <div>
            <label>Nama Fakultas</label>
            <input type="text" name="nama_fakultas" class="form-control" value="<?php echo $fak->nama_fakultas ?>">
          </div>
            <button type="submit" class="btn btn-success mt-3 btn-sm" ><i class="fa fa-save mr-1"></i>Simpan data</button>
            <a href="<?php echo base_url('admin/fakultas') ?>" class="btn btn-warning btn-sm mt-3" >Kembali</a>
          </div>
        </form>
      <?php endforeach; ?>
      </div>
